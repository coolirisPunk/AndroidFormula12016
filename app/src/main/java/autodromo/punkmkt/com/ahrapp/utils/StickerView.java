...
/**
 * Created by germanpunk on 11/08/16.
 */
...
public abstract class StickerView extends FrameLayout{
    ...
    private void init(Context context){
        ...
        this.iv_scale.setImageResource(R.drawable.arrow_colors);
        this.iv_delete.setImageResource(R.drawable.arrow_colors);
        this.iv_flip.setImageResource(R.drawable.arrow_colors);
