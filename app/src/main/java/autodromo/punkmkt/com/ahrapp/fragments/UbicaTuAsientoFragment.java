...
public class UbicaTuAsientoFragment extends Fragment implements OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,LocationListener, GoogleMap.OnMapClickListener, GoogleMap.OnMapLongClickListener, UbicaAsientoDialogFragment.UbicaAsientoDialogListener {
    ...
    LatLng NEWARK = new LatLng(19.401425, -99.091368); //autodromo
//19.404415,-99.0953427
    private final int MAX_ZOOM = 16;
    private final int MIN_ZOOM = 13;
    private final int ZOOM_MAP = 14;
...
//        mGoogleApiClient.connect();
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        if (mLastLocation != null) {
            ...
            m.position(NEWARK_CURRENT_LOCATION).icon(BitmapDescriptorFactory.fromResource(R.drawable.white_pinb));
        ...
        LatLngBounds BOUNDS = new LatLngBounds(new LatLng(19.392129, -99.104139),new LatLng(19.410203, -99.078717));
        GroundOverlayOptions newarkMap = new GroundOverlayOptions()
                .image(BitmapDescriptorFactory.fromBitmap(decodeSampledBitmapFromResource(getResources(), R.drawable.mapa_ahr_ground, 500, 378)))
                //.position(NEWARK, 2630f, 1915f)
        ...
        MarkerOptions m = new MarkerOptions();
        m.position(NEWARK).icon(BitmapDescriptorFactory.fromResource(R.drawable.black_pinb));
        mGoogleMap.addMarker(m).setVisible(true);
        mGoogleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(NEWARK, ZOOM_MAP)); //asiento
    ...
    public void onLocationChanged(Location location) {
        ...
        markerOptions.icon(BitmapDescriptorFactory.fromResource(R.drawable.white_pinb));
