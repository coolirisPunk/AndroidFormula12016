...
public class LaciudadFragment extends Fragment {
    ...
    private void setupTabIcons() {
        ...
        view2.findViewById(R.id.icon).setBackgroundResource(R.drawable.laciudad_food_icon);
                    ...
                    public void onTabSelected(TabLayout.Tab tab) {
                        ...
                        switch (tab.getPosition()){
                            case 0:
                                ...
                                break;
                            case 1:
                                tab.getCustomView().findViewById(R.id.icon).setBackgroundResource(R.drawable.laciudad_food_icon_hover);
                                break;
                            case 2:
                    ...
                    public void onTabUnselected(TabLayout.Tab tab) {
                        ...
                        switch (tab.getPosition()){
                            case 0:
                                ...
                                break;
                            case 1:
                                tab.getCustomView().findViewById(R.id.icon).setBackgroundResource(R.drawable.laciudad_food_icon);
                                break;
                            case 2:
