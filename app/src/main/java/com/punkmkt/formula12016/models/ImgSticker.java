...
import com.punkmkt.formula12016.utils.MultiTouchController;

/**
 * Created by germanpunk on 09/08/16.
 */
public class ImgSticker {
    private int resId;
    ...
    public ImgSticker(int resId, Resources res) {
        this.resId = resId;
        this.firstLoad = true;
        getMetrics(res);
    }
